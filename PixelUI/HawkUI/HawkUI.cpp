...
namespace HawkBaseUI {
    ...
    void HoverableRectangleWithText(std::string option, int index)
    {
        ...
        ImVec2 frontRectSize = { currentWidth, optionSize.y };
    ...
    void End()
    {
        ...
        ImVec2 textPos = { menuPos.x + 10.0f, currentYPosition };

        draw::RectFilled(bottomEndBoxColor, ImVec2(textPos.x - 14.0f, textPos.y - .3f), footerSize);
        std::string pageCount = "Page " + std::to_string(currentPage) + "/" + std::to_string(totalPages);
        draw::Text(pageCount, textOnNormalColor, ImVec2(textPos.x - rightSideTextOffet, textPos.y + 2.f), nullptr, true);
    ...
    void RenderMenu()
    {
        ...
        control::ControlTick();
        optionCount = 0;
        if (ImGui::Begin("HawkUI", nullptr, menuWindowFlags))
        {
            ...
            UIOptions::Button("Normal Button3");
            UIOptions::Button("Normal Button3");
            UIOptions::Toggle("Normal Button3", testbool2);
            UIOptions::Button("Normal Button3");
            ...
            UIOptions::Button("Normal Button3");
            UIOptions::Button("Normal Button4");
            UIOptions::Button("Normal Button3");
            UIOptions::Button("Normal Button3");
            UIOptions::Button("Normal Button3");
            UIOptions::Button("Normal Button3");
