...
namespace notify
{
	...
	inline void render()
	{
		...
		for (auto i = 0; i < toast_list.size(); i++)
		{
			...
			ImGui::PushStyleColor(ImGuiCol_WindowBg, ImVec4(ImColor(0, 0, 0, 100)));
			ImGui::SetNextWindowBgAlpha(opacity);
			ImGui::SetNextWindowPos(ImVec2(1920 - NOTIFY_PADDING_X, 1000 - NOTIFY_PADDING_Y - height), ImGuiCond_Always, ImVec2(1.0f, 1.0f));
